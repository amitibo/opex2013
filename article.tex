...
\begin{abstract}
  ...
  sky on a very large scale. The sensing can use an array of cameras in visible light.
...
\Cref{fig:cross_sections}(a) compares photographs of the {\em Haze Blobs} scene described in \cref{sec:simul}.
