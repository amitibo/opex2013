...
\begin{table}[htbp]
  ...
  \begin{tabular}{cccccgg}
    \toprule
    Scene      & Forward        & Aerosol density & Isotropic       & Absorbing & $\epsilon$ & Mass \\
               & model          & order           & Phase function? & aerosol?  &            & diff. \\
     \midrule
    Haze Front & Single scatter & $10^{6}$         &                 &           & 0.18       & 1.1\%  \\
               & Monte Carlo    & $10^{6}$         &                 &           & 0.65       & 14\%  \\
    \cmidrule(r){1-5}
    Haze Blobs & Single scatter & $10^{6}$         &                 &           & 0.14       & 0\%  \\
               & Monte Carlo    & $10^{6}$         &                 &           & 0.65       & 6.7\%  \\
