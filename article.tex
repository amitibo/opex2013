...
\begin{figure}[t]
  ...
  \caption{\small Cross-sections along the $X$-axis of photographs rendered
    ...
    the increased aerosol density scene (\cref{fig:simulation_particles}(d)).
  }
...
\begin{table}[htbp]
  ...
  \begin{tabular}{cccccgg}
    \toprule
    Scene      & Forward        & Aerosol          & Isotropic       & Absorbing & $\epsilon$ & Mass \\
               & model          & density order    & Phase function? & aerosol?  &            & diff. \\
     \midrule
    Haze       & Single scatter & $10^{6}$         &                 &           & 0.18       & 1.1\%  \\
    Front      & Monte Carlo    & $10^{6}$         &                 &           & 0.65       & 14\%  \\
    \cmidrule(r){1-5}
    Haze       & Single scatter & $10^{6}$         &                 &           & 0.14       & 0\%  \\
    Blobs      & Monte Carlo    & $10^{6}$         &                 &           & 0.65       & 6.7\%  \\
               & Monte Carlo    & $10^{6}$         & $\surd$         &           & 0.49       & 2\%  \\
               & Monte Carlo    & $10^{6}$         &                 & $\surd$   & 0.83       & 9.6\%  \\
               & Monte Carlo    & $10^{7}$         &                 &           & 0.98       & 23\%  \\
    \bottomrule
  \end{tabular}
