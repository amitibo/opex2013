...
Particularly, $\DistEstimated$ is non-negative, and it has limited spatial
support between the ground and the TOA. The optimization problem is,
\begin{equation}
...
\begin{equation}
  ...
  \| \MaskSun \roundy{{\bm i}^{\rm measured}_c - {\bm i}_c({\bm n})}\|^2_2
  + \eta \Psi({\bm n})
\end{equation}
where $\MaskSun$ is a map that masks the areas around the sun, which are
