...
\begin{figure}
  ...
  \caption{\small Different view-points of a sky that includes {\em
      Haze Blobs}. Images rendered using the single-scattering model.
...
\begin{figure}
  \centering
  \yoavcomment{\includegraphics[width=\linewidth]{images/mcgrid.pdf}}
  \caption{\small [a] Multiple-scattering forward model by Monte
    Carlo. [b] Photograph of the same sky and view point as in
    \cref{fig:simulation-results1}, rendered using a MC model.
...
the BMBF. Part of this work was per- formed at the Jet Propulsion
