...
\begin{figure}
  ...
  \caption{\small Monte Carlo simulation of Multiple-Scattering Radiative Transfer.}
  \label{fig:mcgrid}
\end{figure}
...
or~\cref{eq:rayleighP}. This yields a new {\em ray}, denoted ${\cal
  R}_{i+1}$, emanating from ${\bf X}_{i}$. The next iteration of
propagation (denoted {\tt ii} above) proceeds.

\noindent Local Estimation~\cite{marshak20053d} is used for
calculating the amount of light back-traced to the sun at each
scattering.
