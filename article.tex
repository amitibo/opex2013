...
\cref{eq:bigIA}. \hl{Figs. 6.3 to Fig. 6.14 in every comparison, for display purposes both images underwent same contrast streching operations, and used the same colormap}.
...
orders of scattering and discrete ordinates methods). We may tap into some of these approaches.
...
%The work in Caltech was partly supported by ONR-Global grant  N62909-10-1-4056.
