...
\bibitem{cornette1992physically}
...
\begin{figure*}[t!]
  \begin{center}
    \yoavcomment{\includegraphics[width=\linewidth]{groundtomog24.pdf}}
  \end{center}
...
\begin{figure}
  \centering
  \yoavcomment{\includegraphics[width=\columnwidth]{distributions}}
...
\begin{figure}
  \centering
  \yoavcomment{\includegraphics[width=\linewidth]{single_images.pdf}}
...
\end{figure}
\Cref{fig:simulation-results1} shows examples of photographs rendered
using the single-scattering model. To create such photographs we
...
The recovery algorithm, of course, uses the raw (not brightness
enhanced) images.
...
\begin{figure}
  \centering
  \yoavcomment{\includegraphics{mcgrid.pdf}}
...
Similarly, \cref{fig:simulation_particles}(a) corresponds to the same
viewpoint as \cref{fig:simulation-results1}(d).
\begin{figure}[t]
  \centering
  \yoavcomment{\includegraphics{simulation_particles.pdf}}
...
\begin{figure}[bt]
  \centering
  \yoavcomment{\includegraphics{scatter_order.pdf}}
...
\Cref{fig:cross_sections} plots the image intensity profile along a straight
line from left to right, via the image center (zenith). The plot compares
photographs simulated using the single-scattering and the  MC forward models.
\Cref{fig:cross_sections}(a) is extracted from \cref{fig:simulation-results1}(d)
...
\Cref{fig:cross_sections}(b) plots the same profiles,
where the aerosol density was increased tenfold (see \cref{sec:optimization-results}
and the corresponding MC photograph, \cref{fig:simulation_particles}(d)).
In \cref{fig:cross_sections}(b) the plots differ more than in \cref{fig:cross_sections}(a),
due to high order scattering.
\begin{figure}[t]
  \centering
  \yoavcomment{\includegraphics{cross_sections.pdf}}
...
\begin{figure}[b]
  \centering
  \yoavcomment{\includegraphics{results}}
...
\Cref{fig:error_vs_cameras} plots the performance.
\begin{figure}[t]
  \centering
  \yoavcomment{\includegraphics{error_vs_cameras.pdf}}
...
\begin{figure}[b]
  \centering
  \yoavcomment{\includegraphics{reconstructions.pdf}}
