...
We simulate RT through the atmosphere using two models. The first is
based on Monte Carlo (MC) methods (\cref{sec:monte-carlo-simul}) and
models Multiple-Scattering. Therefore it enables simulating realistic
